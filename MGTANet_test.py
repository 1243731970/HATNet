...
parser.add_argument('--iou_path', type=str, default='IOU/', help='IOU 保存路径')
parser.add_argument('--iou_file', type=str, default='BPV.txt', help='IOU 文件名')
opt = parser.parse_args()

# 数据集路径
dataset_path = './dataset/PV/test/'

# 模型
model = MCCNet_VGG()
model.load_state_dict(
    {k: v for k, v in torch.load('save/BASE/PV/MCCNet_VGG.pth.49', map_location='cpu').items()
